angular.module('realValue')
    ...
    .controller("mapController", [ '$scope', '$http', 'leafletData', 'leafletMapEvents', 'checkboxService','dataService','$mdDialog', '$q', 'geoCodingService', 'leafletBoundsHelpers', function($scope, $http, leafletData, leafletMapEvents, checkboxService,dataService, $mdDialog, $q, geoCodingService, leafletBoundsHelpers) {
        var mc = this;
        var varMap;
        //mc.gjLayer;
                ...
                if(match) {
                    ...
                    geoCodingService.getAPI(zip).then(function(response){
                        ...
                        if(matched_state === 'CA' && (matched_county === 'Orange County' || matched_county === 'Los Angeles County')) {
                            ...
                            alert("Cannot search outside Los Angeles or Orange County");
                        }

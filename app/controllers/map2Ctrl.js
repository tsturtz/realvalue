angular.module('realValue')
    ...
    .controller("map2Ctrl", [ '$scope', '$http', 'leafletData', 'leafletMapEvents', function($scope, $http, leafletData,leafletMapEvents) {
        ...
        angular.extend($scope, {
            center: {
                lat: 33.66946125651901,
                lng: -117.73013591766357,
                zoom: 13
            },
            tiles: {
